...
function GoogleIcon(props: IconProps) {
  return (
    <svg {...props} width="64" height="64" viewBox="0 0 32 32">
      ...
      <path fill="#fbbc05" d="M0 37V11l17 13z" clipPath="url(#b)" transform="matrix(.72727 0 0 .72727 -.955 -1.455)" />
      <path fill="#ea4335" d="m0 11 17 13 7-6.1L48 14V0H0z" clipPath="url(#b)" transform="matrix(.72727 0 0 .72727 -.955 -1.455)" />
      <path fill="#34a853" d="m0 37 30-23 7.9 1L48 0v48H0z" clipPath="url(#b)" transform="matrix(.72727 0 0 .72727 -.955 -1.455)" />
      <path fill="#4285f4" d="M48 48 17 24l-4-3 35-10z" clipPath="url(#b)" transform="matrix(.72727 0 0 .72727 -.955 -1.455)" />
    </svg>
  )
}
